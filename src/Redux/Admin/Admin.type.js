...
export const UPDATE_ADMIN_NAME='add/adminName';
export const UPDATE_ADMIN_EMAIL='add/adminEmail';
export const UPDATE_ADMIN_CONTACT='add/adminContact';
export const UPDATE_ADMIN_PASSWORD='add/adminPassword';
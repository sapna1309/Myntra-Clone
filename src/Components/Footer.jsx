        ...
        >
          ...
          <VStack>
            ...
            <Stack border={"0px solid red"} align={"flex-center"}>
              <Text mt={"30px"} fontSize={"14px"} fontWeight={"bold"}>
                KEEP IN TOUCH
              </Text>
      ...
      {/* <Flex direction={"column"}>
        <VStack maxW={"5xl"} m={"auto"} border={"0px solid black"} ml={"23%"}>
          <Flex
            ...
            border={"0px solid black"}
          >
            <Text align={"flex-start"} fontSize={"14px"} fontWeight={"bold"}>
              POPULAR SEARCHES
            </Text>
            <Text align={"flex-start"}>
              jacketsGreen dress Boys Clothing Men KurtisTrack PantMen KurtasGym
              WearParty DressesPalazzo SuitsBoys ClothingGlovesNightyMaxi
            </Text>
            <Text>
              WearBriefs dress materialBlack ShortsGeorgette WearBriefs
              SareesEthnic dressesKids WearBriefs dressesSleeveless shrugs Boys
              clothing
            </Text>
            <Text>
              Salwar SuitsKurtisDesigner WearBriefs Sarees Sarees & TrunksNike
              WatchesAscot SareesTieCorset Tops TunicsLeather magenta earring
            </Text>
            <Text>
              Salwar SuitsKurtisDesigner Sarees WearBriefs & TrunksNike
              WatchesAscot WearBriefs Sarees Bra TieCorset Tops TunicsLeather
              magenta{" "}
            </Text>
            <Text>
              Woodland ShoesSkechers Shoes Sarees Wear Briefs Shoes Loafers Bra
              SandalsLotto Sports Sarees ShoesCasual ShoesWomens Skechers{" "}
            </Text>
            <Flex gap={"5px"} mt={"2%"}>
